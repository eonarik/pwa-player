...
[x] Яндекс.Диск через Node-прокси
[x] Кэш библиотеки Диска с TTL
[x] Мобильная адаптация (safe-area, overscroll)
...
[] Capacitor-обёртка для iOS (если понадобится доступ к файлам)
