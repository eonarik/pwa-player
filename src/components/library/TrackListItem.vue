...
<template>
  <div class="group relative">
    <button
      ...
      :class="
        isCurrent ? 'bg-emerald-500/10 text-emerald-400' : 'text-zinc-300 hover:bg-zinc-800/60'
      "
    ...
    >
      ...
      <!-- Длительность (сдвигается, если есть слот actions) -->
      <span
        class="shrink-0 text-xs tabular-nums text-zinc-500 transition-opacity"
